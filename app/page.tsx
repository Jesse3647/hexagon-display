...
export default function Home() {
  ...
  // Register browser tools once, but read live state through a ref on every call.
   ...
   * @param separate True tests separately printed strips; false tests release after printing.
